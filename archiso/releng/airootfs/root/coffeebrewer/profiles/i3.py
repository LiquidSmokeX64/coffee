...
def _prep_function(*args, **kwargs):
	...
	if choice.value:
		...
		coffeebrewer.storage['_i3_configuration'] = choice.value
...
if __name__ == 'i3':
	...
	coffeebrewer.storage['installation_session'].add_additional_packages(__packages__[:4])
	...
	coffeebrewer.storage['installation_session'].add_additional_packages(coffeebrewer.storage['_i3_configuration'])
