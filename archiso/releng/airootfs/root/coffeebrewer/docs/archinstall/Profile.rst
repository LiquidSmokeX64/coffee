.. _coffeebrewer.Profile:

coffeebrewer.Profile
===================

This class enables access to pre-programmed profiles.
This is not to be confused with :ref:`coffeebrewer.Application` which is for pre-programmed application profiles.
...
And that's the difference between :ref:`coffeebrewer.Profile` and :ref:`coffeebrewer.Application`.

.. autofunction:: coffeebrewer.Profile
