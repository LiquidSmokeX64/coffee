...
from ..user_interaction.general_conf import select_coffeebrewer_language
...
class AbstractMenu:
	...
	def __exit__(self, *args :Any, **kwargs :Any) -> None:
		...
		if len(args) >= 2 and args[1]:
			...
			print("    Please submit this issue (and file) to https://github.com/archlinux/coffeebrewer/issues")
			raise args[1]
	...
	def _select_coffeebrewer_language(self, preset_value: Language) -> Language:
		language = select_coffeebrewer_language(self.translation_handler.translated_languages, preset_value)
