...
def ask_ntp(preset: bool = True) -> bool:
	...
	prompt += str(_('Hardware time and other post-configuration steps might be required in order for NTP to work.\nFor more information, please check the Coffee wiki'))
	if preset:
		preset_val = Menu.yes()
	else:
		preset_val = Menu.no()
...
def select_language(preset_value: str = None) -> str:
	...
	Usually this is combined with :ref:`coffeebrewer.list_keyboard_languages`.
...
def select_mirror_regions(preset_values: Dict[str, Any] = {}) -> Dict[str, Any]:
	...
	Usually this is combined with :ref:`coffeebrewer.list_mirrors`.
...
def select_coffeebrewer_language(languages: List[Language], preset_value: Language) -> Language:
