"""Coffee Linux installer - guided, templates etc."""
import typing
...
def load_config():
	...
	if (coffeebrewer_lang := arguments.get('coffeebrewer-language', None)) is not None:
		arguments['coffeebrewer-language'] = TranslationHandler().get_language_by_name(coffeebrewer_lang)
...
# @coffeebrewer.plugin decorator hook to programmatically add
...
def run_as_a_module():
	"""
	Since we're running this as a 'python -m coffeebrewer' module OR
