...
struct qt_meta_stringdata_KDSingleApplicationLocalSocket_t {
    QByteArrayData data[6];
    char stringdata0[76];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_KDSingleApplicationLocalSocket_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_KDSingleApplicationLocalSocket_t qt_meta_stringdata_KDSingleApplicationLocalSocket = {
    {
QT_MOC_LITERAL(0, 0, 30), // "KDSingleApplicationLocalSocket"
QT_MOC_LITERAL(1, 31, 15), // "messageReceived"
QT_MOC_LITERAL(2, 47, 0), // ""
QT_MOC_LITERAL(3, 48, 7), // "message"
QT_MOC_LITERAL(4, 56, 11), // "sendMessage"
QT_MOC_LITERAL(5, 68, 7) // "timeout"

    },
    "KDSingleApplicationLocalSocket\0"
    "messageReceived\0\0message\0sendMessage\0"
    "timeout"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_KDSingleApplicationLocalSocket[] = {
...
QT_INIT_METAOBJECT const QMetaObject KDSingleApplicationLocalSocket::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_KDSingleApplicationLocalSocket.data,
    qt_meta_data_KDSingleApplicationLocalSocket,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *KDSingleApplicationLocalSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDSingleApplicationLocalSocket.stringdata0))
