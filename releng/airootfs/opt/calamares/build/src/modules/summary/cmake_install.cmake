# Install script for directory: /home/fahr/calamares/src/modules/summary
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "CALAMARES" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/calamares/modules/summary" TYPE SHARED_LIBRARY FILES "/home/fahr/calamares/build/src/modules/summary/libcalamares_viewmodule_summary.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/calamares/modules/summary/libcalamares_viewmodule_summary.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/calamares/modules/summary/libcalamares_viewmodule_summary.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/calamares/modules/summary/libcalamares_viewmodule_summary.so"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "CALAMARES" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/calamares/modules/summary" TYPE FILE FILES "/home/fahr/calamares/build/src/modules/summary/module.desc")
endif()
